...
RUN apt install -y python-rosinstall python-rosinstall-generator python-wstool python-catkin-tools build-essential
...
ENTRYPOINT $CATKIN_WS/src/kair_algorithms_draft/docker_train.sh
